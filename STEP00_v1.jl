...
#=
    Module STEP00_v1
    ---                                                                               ---
        This module was designed for the processing and analysis of data obtained from brw
        files (HDF5), which are experiments conducted using the 3Brain HD-MEA: BioCam X.
        In our case, we use this system to record electrical activity from rodent hippocampal
    ...
    - For installing the needed native packages, these are commands to run in the Julia REPL
        or a Julia script:
        >>
        using Pkg
        Pkg.update( );
    ...
    * Smoe comments and descriptions in this module were automatically generated by ChatGPT
=#
# ----------------------------------------------------------------------------------------- #
